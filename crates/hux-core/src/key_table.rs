...
pub static MODIFIER_NAMES: [Option<&str>; 32] = [
    Some("Shift"),
    Some("Lock"),
    Some("Control"),
    Some("Alt"),
...
/// 按名字查找键值时的扫描序（与 librime 同序，首个匹配生效）。
pub static KEYS_BY_KEYVAL: [(i32, &str); 1306] = [
    (0x000020, "space"),
    (0x000021, "exclam"),
    (0x000022, "quotedbl"),
    (0x000023, "numbersign"),
...
/// 按键值查找键名时的扫描序（与 librime 同序，首个匹配生效）。
pub static KEYS_BY_NAME: [(i32, &str); 1306] = [
    (0x000030, "0"),
    (0x000031, "1"),
    (0x000032, "2"),
    (0x000033, "3"),
