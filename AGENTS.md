...
- 文档：`docs/rust-migration.md`（设计）、`docs/rime-semantics.md`（参照行为）、`docs/spike-report.md`（K0 结果）、`docs/LEXICAL_PRIOR_ATTRIBUTION.md`（词先验署名/许可）、`docs/reverse-lookup.md`（⑧ 反查勘察/方案）。
